...
def userAction(driver):
    reward_time = 10
    total_reward_time = userAction("KEYWORD", driver, reward_time, ["CSUSB"])
    tag_name = ["p"]
    total_reward_time += userAction("PARAGRAPHS", driver, reward_time, tag_name)
    tag_name = ["div"]
    total_reward_time += userAction("DIVIDERS", driver, reward_time, tag_name)
    tag_name = ["img"]
